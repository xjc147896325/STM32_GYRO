...
//	GPIO_Init( SPI_CLK_GPIO_PORT, &GPIO_InitStructure );		//初始化SCK
	...
	GPIO_PinAFConfig(SPI_CLK_GPIO_PORT,GPIO_PinSource5,GPIO_AF_SPI1); //PB3复用为 SPI1
	
	GPIO_PinAFConfig(SPI_MOSI_GPIO_PORT,GPIO_PinSource7,GPIO_AF_SPI1); //PB4复用为 SPI1

	GPIO_PinAFConfig(SPI_MISO_GPIO_PORT,GPIO_PinSource6,GPIO_AF_SPI1); //PB5复用为 SPI1
